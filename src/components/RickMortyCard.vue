<template>
  <div class="black-bg">
    <div class="rounded-md m-[20px] h-[600px] gray-bg">
        <!-- Image -->
      <img
      ...
      <div class="flex flex-col mx-4">
        ...
        <!-- SPECIES -->
            ...
            <div class="flex flex-row justify-around p-3 gap-2 ml-4">
                ...
                <h4 class="text-amber-700  text-xs">{{rickMortyCharacter.origin.name}}</h4>
            </div>
            <hr class="w-3/4 mx-auto"   />
            ...
            <div class="flex flex-row justify-around p-3 gap-2 ml-4">
                ...
                <h4 class="text-amber-700  text-xs">{{rickMortyCharacter.location.name}}</h4>
            </div>
            <hr class="w-3/4 mx-auto"   />
